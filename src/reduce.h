...
//        void print_solution(const IloCplex& cplex, const IloArray<IloNumVarArray>& x) const;
        public:
            ...
            float get_predicted_value(std::uint32_t i, std::uint32_t j) const { return predicted_value[i][j]; }
